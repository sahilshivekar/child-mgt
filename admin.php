<?php
// Example predefined admin credentials (can be replaced by database check)
$admin_email = "admin@69.com";
...
if (isset($_POST['login'])) {
    ...
    if ($email === $admin_email && $password === $admin_password) {
        ...
        $_SESSION['admin'] = $email; // Store session data
        header("Location: admindshbrd.php");
        exit;
    } else {
...
<head>
    ...
    <title>Admin Login - Child Vaccination System</title>
